...
#if !UVGRTP_HAS_SRTP
    if (rce_flags & (RCE_SRTP | RCE_SRTP_KMNGMNT_USER | RCE_SRTP_KMNGMNT_ZRTP |
...
#endif
#if !UVGRTP_HAS_ZRTP
    if (rce_flags & (RCE_ZRTP_DIFFIE_HELLMAN_MODE | RCE_ZRTP_MULTISTREAM_MODE | RCE_SRTP_KMNGMNT_ZRTP)) {
