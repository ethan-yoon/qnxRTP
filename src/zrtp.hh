...
namespace uvgrtp {
    ...
    class zrtp {
        public:
            ...
            rtp_error_t init(uint32_t, std::shared_ptr<uvgrtp::socket>, sockaddr_in&, sockaddr_in6&, bool, bool)
            {
            ...
            rtp_error_t packet_handler(void*, int, uint8_t*, size_t, frame::rtp_frame**)
            {
                return RTP_NOT_SUPPORTED;
            }
